...
SVGTabSwitchControl::SVGTabSwitchControl(
  const IRECT& bounds, IActionFunction aF, const ISVG& offImage, const ISVG& onImage, const std::vector<const char*>& options, const char* label, float gap, const IVStyle& style, EDirection direction)
...
SVGTabSwitchControl::SVGTabSwitchControl(
  const IRECT& bounds, int paramIdx, const ISVG& offImage, const ISVG& onImage, const std::vector<const char*>& options, const char* label, float gap, const IVStyle& style, EDirection direction)
