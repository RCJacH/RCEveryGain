...
def main():
  ...
  plistpath = scriptpath + "/resources/RCEveryGain-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/RCEveryGain-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/RCEveryGain-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/RCEveryGain-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/RCEveryGain-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/RCEveryGain.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/RCEveryGain.iss",inplace=1):
