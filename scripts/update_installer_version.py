...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=RCEveryGain Demo Installer\n"
      else:
        line="OutputBaseFilename=RCEveryGain Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the RCEveryGain Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the RCEveryGain installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=RCEveryGain Demo installer\n"
     else:
       line="SetupWindowTitle=RCEveryGain installer\n"
